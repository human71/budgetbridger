...
const Component3 = (props) => {
  return (
    <div className={`component3-feature-card ${props.rootClassName} `}>
      ...
      <h2 className="component3-text">{props.title}</h2>
      <span className="component3-text1">{props.description}</span>
    </div>
  )
}
...
Component3.defaultProps = {
  rootClassName: '',
  description:
    'Delve into your financial past with the Expense History Archive',
