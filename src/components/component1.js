...
const Component1 = (props) => {
  return (
    <div className={`component1-feature-card ${props.rootClassName} `}>
      ...
      <h2 className="component1-text">{props.title}</h2>
      <span className="component1-text1">{props.description}</span>
    </div>
  )
}
...
Component1.defaultProps = {
  ...
  action: 'SEE MORE',
  description: 'Keep a pulse on your finances at a glance.',
}
