...
const AppComponent = (props) => {
  return (
    <div className={`app-component-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="app-component-icon">
        <path
      ...
      <span className="app-component-text1">{props.description}</span>
    </div>
  )
}

AppComponent.defaultProps = {
  description: 'Stay informed about where your money is going',
  rootClassName: '',
