...
const Component2 = (props) => {
  return (
    <div className={`component2-feature-card ${props.rootClassName} `}>
      ...
      <h2 className="component2-text">{props.title}</h2>
      <span className="component2-text1">{props.description}</span>
    </div>
  )
}

Component2.defaultProps = {
  description: 'Empower managers with the ability to create expenses',
